...
export async function getFarcasterMetadata(): Promise<FrameMetadata> {
  ...
  if (secretEnvVars) {
    ...
    console.log("Generated signed account association", accountAssociation);
  }
  ...
  return {
    accountAssociation: {
      ...
      payload: "eyJkb21haW4iOiJuaW5ldHktdGFibGVzLXRhbGsubG9jYS5sdCJ9",
      signature:
        "MHhkZGU2Mjg2NDMwNTU2ODUzYzRjNjI0YmMwMjFkM2JjNGI4OGU3NDI0NzI0NTY5OTljNWQ1ZGU3OTk3ZTEzNmZmNTNjYmNhMzY2MjljYjRlYTk4MTQ0YjZkNDdiMDc5MTExYmJjYWMzOGNjNDA5Yjg1ZTBiYTMxMWQ3MjZlYjg3OTFi",
    },
    frame: {
      version: "1",
